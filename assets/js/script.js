...
// Random cocktail variables
    ...
    var drinkIngredientList = document.querySelector ("#ingred-Dlist");
...
var mealIngredientList = document.querySelector ("#ingred-Mlist");
...
.then(function(response) {
 ...
 .then(function(data) {
  ...
  //for loop for cocktails
     for(var i = 1; i <= 20; i++){
       // var tempDrinkIngredient = data.drinks[0]['strIngredient' + i ]; 
        drinkIngredientList = data.drinks[0]['strIngredient' + i ]; 
        if(!drinkIngredientList)
        {
            break;
        }
        //risk if empty or only 2 ingredientss
       // var tempDrinkPtag = document.createElement("p");
        var drinkPtag = document.createElement("p");
        document.body.append(drinkPtag);
        // var tempIngredient = data.meals[0].strIngredient1; //142 old way
        
        drinkPtag.innerHTML = drinkIngredientList;
        document.getElementById("ingred-Dlist").innerHTML = drinkIngredientList;
    }
    ...
    .then(function(data) {
       ...
       //  var ingredientArray = [mealIngredient2,mealIngredient2,mealIngredient3,mealIngredient4,mealIngredient5,mealIngredient6,mealIngredient7];
        ...
        for(var i = 1; i <= 20; i++){
            ...
            document.body.append(tempPtag);
            // var tempIngredient = data.meals[0].strIngredient1; //142 old way
            
            tempPtag.innerHTML = mealIngredientList;
